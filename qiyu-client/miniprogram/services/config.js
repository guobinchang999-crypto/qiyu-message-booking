...
const hasDeploymentConfig = deployment_1.deploymentConfig.mode === 'prod' && /^https:\/\//.test(deployment_1.deploymentConfig.baseUrl);
exports.apiMode = hasDeploymentConfig ? 'prod' : readStoredApiMode();
...
exports.apiConfig = hasDeploymentConfig
    ? { ...exports.apiConfigs.prod, baseUrl: deployment_1.deploymentConfig.baseUrl.replace(/\/$/, '') }
    : (exports.apiMode === 'prod' && storedBaseUrl ? { ...exports.apiConfigs.prod, baseUrl: storedBaseUrl } : exports.apiConfigs[exports.apiMode]);
/**
