...
export default function TherapistsPage() {
  ...
  return <div className="qiyu-page">
    ...
    <Modal title={editing ? '编辑技师' : '新增技师'} open={open} confirmLoading={saving} onOk={submit} onCancel={() => setOpen(false)} width={620} destroyOnClose><Form form={form} layout="vertical" preserve={false} initialValues={initialValues} style={{ marginTop: 20 }}>
