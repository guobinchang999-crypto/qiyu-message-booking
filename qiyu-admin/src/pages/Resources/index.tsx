...
export default function ResourcesPage() {
  ...
  return <div className="qiyu-page">
    ...
    <Modal title={editing ? '编辑排班' : '新增排班'} open={open} confirmLoading={saving} onOk={submit} onCancel={() => setOpen(false)} destroyOnClose><Form form={form} layout="vertical" preserve={false} style={{ marginTop: 20 }}>
