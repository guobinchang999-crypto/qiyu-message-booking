...
public interface SystemManagementMapper extends BaseMapper<SystemUserEntity> {
    ...
    @Select("""
            ...
            """)
    List<Map<String, Object>> organizations(@Param("keyword") String keyword, @Param("pattern") String pattern,
    ...
    @Select("""
            ...
            """)
    List<Map<String, Object>> users(@Param("keyword") String keyword, @Param("pattern") String pattern,
                                    @Param("limit") int limit, @Param("offset") int offset);
    ...
    @Insert("INSERT INTO sys_user_data_scope(user_id,resource_code,action_code,scope_type,created_by_user_id) VALUES(#{userId},#{resource},'*',#{scope},#{operatorId})")
    int insertUserScope(@Param("userId") long userId, @Param("resource") String resource, @Param("scope") String scope, @Param("operatorId") long operatorId);
    ...
    @Select("""
            ...
            """)
    List<Map<String, Object>> roles(@Param("keyword") String keyword, @Param("pattern") String pattern,
                                    @Param("limit") int limit, @Param("offset") int offset);
    ...
    @Insert("INSERT INTO sys_role_permission(role_id,permission_id,effect) VALUES(#{roleId},#{permissionId},'ALLOW')") int insertRolePermission(@Param("roleId") long roleId, @Param("permissionId") long permissionId);
    ...
    @Select("""
            ...
            """)
    List<Map<String, Object>> menus(@Param("keyword") String keyword, @Param("pattern") String pattern,
                                    @Param("limit") int limit, @Param("offset") int offset);
    ...
    @Select("""
            ...
            """)
    List<Map<String, Object>> dictionaries(@Param("keyword") String keyword, @Param("pattern") String pattern,
                                           @Param("limit") int limit, @Param("offset") int offset);
    ...
    @Select("""
            ...
            """)
    List<Map<String, Object>> auditLogs(@Param("keyword") String keyword, @Param("pattern") String pattern,
                                        @Param("limit") int limit, @Param("offset") int offset);
