...
public class BookingController {
    ...
    public BookingController(BookingAppService bookingAppService, BookingQueryService bookingQueryService) {
    ...
    public ApiResponse<BookingOperationVO.Confirmation> confirmation(@Valid @RequestBody BookingConfirmationRequest request) {
        return ApiResponse.success(bookingQueryService.confirmation(request.storeId(), request.serviceId(), request.therapistId(),
